...
-- Дамп структуры базы данных u1073790_marlin
CREATE DATABASE IF NOT EXISTS `u1073790_marlin` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `u1073790_marlin`;

-- Дамп структуры для таблица u1073790_marlin.images
...
-- Дамп данных таблицы u1073790_marlin.images: ~5 rows (приблизительно)
...
-- Дамп структуры для таблица u1073790_marlin.my_registration
...
-- Дамп данных таблицы u1073790_marlin.my_registration: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица u1073790_marlin.my_table
...
-- Дамп данных таблицы u1073790_marlin.my_table: ~6 rows (приблизительно)
...
-- Дамп структуры для таблица u1073790_marlin.people
...
-- Дамп данных таблицы u1073790_marlin.people: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица u1073790_marlin.tasks
...
-- Дамп данных таблицы u1073790_marlin.tasks: ~4 rows (приблизительно)
