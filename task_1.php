...
<!--перекинем ассоциативный массив в functions.php-->
                            <?php
                                include 'functions.php';
                            ?>
<!-- /перекинем ассоциативный массив в functions.php-->

<!-- заполняем элементы из массива -->
                            <ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
                                <?php foreach($itemsTsk01 as $item):?>
<!--                                $itemsTsk01 as $key =>$item вот так вот не надо =) -->
                                ...
                                <?php endforeach; ?>
<!--                                оставил комменты как шпаргалку на гите                 -->
<!--                                <li class="list-group-item">-->
