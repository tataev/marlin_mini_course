                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <?php foreach($itemsTsk04 as $item):?>
                                <div class="d-flex <?php echo $item['dFlex'];?>">
                                    <?php echo $item['title'];?>
                                    <span class="d-inline-block ml-auto">
                                        <?php echo $item['value'];?>
                                    </span>
                                </div>
                                <div class="progress progress-sm <?php echo $item['MbOrMt'];?>">
                                    <div class="progress-bar <?php echo $item['bg'];?>" role="progressbar" style="width: <?php echo $item['width'];?>;" aria-valuenow="<?php echo $item['valuenow'];?>65" aria-valuemin="<?php echo $item['valuemin'];?>" aria-valuemax="<?php echo $item['valuemax'];?>"></div>
                                </div>
                            <?php endforeach; ?>
