...
-- Дамп данных таблицы my_project.my_registration: ~0 rows (приблизительно)
...
-- Дамп данных таблицы my_project.my_table: ~0 rows (приблизительно)
...
-- Дамп данных таблицы my_project.people: ~0 rows (приблизительно)
...
-- Дамп данных таблицы my_project.tasks: ~0 rows (приблизительно)
